  ...
  return (
    <div>
      ...
      <div className="mt-6 px-6">
        ...
        <span className="mt-8 ml-5 block text-white">User Detail's</span>
        <span className="ml-5 text-4xl font-bold text-white">Bus</span>
        <div className="mt-12 flex items-center justify-between rounded-2xl bg-white p-4 py-8 shadow-xl">
          <div
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center space-x-2">
                    <span
                      ...
                      className="flex h-5 w-5 items-center justify-center rounded-full bg-green-500 text-white hover:cursor-pointer"
                    >
                      -
                    </span>
                    <span>{number}</span>
